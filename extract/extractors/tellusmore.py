...
# class TasteExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'TASTE'
#
#
# class AttractExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'ATTRACT'
#
#
# class ExExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'EX'
#
#
# class WILLMTExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'WILL'
#
#
# class MOODDASExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'MOOD'
#
#
# class IMPAMNExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'IMP'
#
#
# class FOODIMPExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'FOOD'
#
#
# class EMREGNGIASCExtractor(AbstractTellUsMoreExtractor):
#     type = 'EMREG'
#
#
# class GOALSExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'GOALS'
#
#
# class INTENTExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'INTENT'
#
#
# class PERSONNEOACExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'PERSON'
#
#
# class EFFECTExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'EFFECT'
#
#
# class MINDFExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'MIND'
#
#
# class RESTRExtractor(AbstractTellUsMoreExtractor):
#
#     type = 'RESTR'
#
